...
function ProjectCard({project}) {
  ...
  return (
    <>
   { project && <Card style={{ width: '28rem' }} className=' shadow btn mb-3' onClick={handleShow}>
        ...
        <Modal.Body>
          <Row>
            ...
            <Col md={6}>
              ...
              <p>Langauge Used: <span className='fw-bolder text-danger'> {project?.languages}</span></p>
            </Col>
          </Row>
          <div className="mt-3">
